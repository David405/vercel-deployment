...
export class UserValidation {
  static usernameSchema = z.object({
    username: z
      ...
      .regex(/^[a-zA-Z0-9-_]+$/, "Username can only contain letters, numbers, underscore, hyphen")
  ...
  static createUserSchema = z
    .object({
      ...
      email: z.string().trim().email("Invalid email format/remove email field in case of empty email for type third-party").optional(),
